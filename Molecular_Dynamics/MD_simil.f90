...
program md
  ...
  ! --- open energy file ---
  open(10, file="md_without_thermostat.dat", status="unknown")
  ...
  call write_config("pos_init.dat", pos)
  call write_config("vel_init.dat", vel)
  ...
  call write_config("pos_final.dat", pos)
  call write_config("vel_final.dat", vel)
